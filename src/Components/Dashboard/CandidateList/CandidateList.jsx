...
const CandidateList = () => {
  ...
  const handleSearch = () => {
    ...
    const queryName = query(candidatesRef, orderByChild('name'),equalTo(searchQuery));
    ...
    if(!queryFound){
      const queryRoll = query(candidatesRef, orderByChild('rollNumber'),equalTo(searchQuery));
    ...
    if(!queryFound && isInteger(searchQuery)){
      const queryPhone = query(candidatesRef, orderByChild('phoneNumber'),equalTo(Number(searchQuery)));
