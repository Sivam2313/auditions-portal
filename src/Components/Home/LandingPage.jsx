    ...
    <div className="w-screen h-screen flex flex-col justify-center items-center z-20">
        ...
        >
            <div className="drop-shadow-glow text-primary">
                <svg className='lg:w-[37px] lg:h-[32px] w-[25px] h-[35px]' viewBox="0 0 50 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12.25 7.21L28.6667 21L12.25 34.79L16.6667 38.5L37.5 21L16.6667 3.5L12.25 7.21Z" fill="white"/>
                </svg>
            </div>
            <div className="text-onSecondary text-md lg:text-2xl flex items-center font-title">
                Join Us And Show Your Talent
            </div>
            <div className="drop-shadow-glow text-primary">
                <svg className='lg:w-[37px] lg:h-[32px] w-[25px] h-[35px]' viewBox="0 0 51 42" fill="none" xmlns="http://www.w3.org/2000/svg">
