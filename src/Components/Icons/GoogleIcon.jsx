...
const GoogleIcon = () => {
  return (
    ...
    <mask id="mask0_8_9" style={{"maskType":"luminance"}} maskUnits="userSpaceOnUse" x="2" y="2" width="43" height="44">
    ...
    <mask id="mask1_8_9" style={{"maskType":"luminance"}} maskUnits="userSpaceOnUse" x="2" y="2" width="43" height="44">
    <path d="M44.5 20H24V28.5H35.8C34.7 33.9 30.1 37 24 37C16.8 37 11 31.2 11 24C11 16.8 16.8 11 24 11C27.1 11 29.9 12.1 32.1 13.9L38.5 7.5C34.6 4.1 29.6 2 24 2C11.8 2 2 11.8 2 24C2 36.2 11.8 46 24 46C35 46 45 38 45 24C45 22.7 44.8 21.3 44.5 20Z" fill="white"/>
    </mask>
    <g mask="url(#mask1_8_9)">
    <path d="M0 11L17 24L24 17.9L48 14V0H0V11Z" fill="#EA4335"/>
    </g>
    <mask id="mask2_8_9" style={{"maskType":"luminance"}} maskUnits="userSpaceOnUse" x="2" y="2" width="43" height="44">
    <path d="M44.5 20H24V28.5H35.8C34.7 33.9 30.1 37 24 37C16.8 37 11 31.2 11 24C11 16.8 16.8 11 24 11C27.1 11 29.9 12.1 32.1 13.9L38.5 7.5C34.6 4.1 29.6 2 24 2C11.8 2 2 11.8 2 24C2 36.2 11.8 46 24 46C35 46 45 38 45 24C45 22.7 44.8 21.3 44.5 20Z" fill="white"/>
    </mask>
    <g mask="url(#mask2_8_9)">
    <path d="M0 37L30 14L37.9 15L48 0V48H0V37Z" fill="#34A853"/>
    </g>
    <mask id="mask3_8_9" style={{"maskType":"luminance"}} maskUnits="userSpaceOnUse" x="2" y="2" width="43" height="44">
    <path d="M44.5 20H24V28.5H35.8C34.7 33.9 30.1 37 24 37C16.8 37 11 31.2 11 24C11 16.8 16.8 11 24 11C27.1 11 29.9 12.1 32.1 13.9L38.5 7.5C34.6 4.1 29.6 2 24 2C11.8 2 2 11.8 2 24C2 36.2 11.8 46 24 46C35 46 45 38 45 24C45 22.7 44.8 21.3 44.5 20Z" fill="white"/>
    </mask>
    <g mask="url(#mask3_8_9)">
